...
import { KetoCakes, KetoCupcakes, ReadyToCook, SugarFreeDesserts, ketoBurger, ketoMains, ketoPasta, ketoPizza, ketoSides, menuPage, menuPage1, menuPage2, soupPage } from './mainPage/Menu';
